        ...
        return (
          ...
          >
            <div className="flex justify-center mb-4">
              <div className="bg-gradient-to-br from-green-400 to-blue-500 p-4 rounded-full">
            ...
            <div className="bg-gradient-to-r from-green-50 to-blue-50 rounded-xl p-4">
              <p className="text-sm text-gray-700 text-center leading-relaxed">
                ...
                <span className="font-semibold text-green-600"> ganhar dinheiro real </span>
              ...
              <div className="bg-gradient-to-r from-yellow-50 to-orange-50 rounded-xl p-4 border border-yellow-200">
                ...
                <div className="space-y-1">
                  <div className="flex items-center justify-between text-xs">
                    ...
                    <span className="font-semibold text-green-600">1-3 pts/min</span>
                  </div>
                  <div className="flex items-center justify-between text-xs">
              ...
              <div className="bg-gradient-to-r from-green-50 to-emerald-50 rounded-xl p-4 border border-green-200">
                ...
                <div className="space-y-2">
                  <div className="flex items-center justify-between bg-white rounded-lg px-3 py-2">
                    ...
                    <span className="text-xs font-bold text-green-600">R$ 7,50</span>
                  </div>
                  <div className="flex items-center justify-between bg-white rounded-lg px-3 py-2">
                  ...
                  <div className="flex items-center justify-between bg-white rounded-lg px-3 py-2">
                    ...
                    <ChevronRight className="w-3 h-3 text-gray-400" />
                    <span className="text-xs font-bold text-green-600">R$ 37,50</span>
                  </div>
                </div>
              </div>
          ...
          >
            ...
            <div className="space-y-2.5">
              ...
              <motion.div
                ...
                animate={{ opacity: 1, x: 0 }}
                transition={{ delay: 0.3 }}
                className="flex items-start gap-3 bg-gradient-to-r from-green-50 to-emerald-50 rounded-xl p-3 border border-green-100"
              >
          ...
          >
            <div className="flex justify-center mb-4">
              <motion.div
                ...
                className="bg-gradient-to-br from-green-400 to-blue-500 p-4 rounded-full"
              >
            ...
            <div className="bg-gradient-to-r from-green-50 to-blue-50 rounded-xl p-4">
              <p className="text-sm text-gray-700 text-center leading-relaxed">
                ...
                <span className="font-semibold text-green-600"> ganhar dinheiro </span>
            ...
            >
              <Button
                onClick={handleStart}
                className="w-full bg-gradient-to-r from-green-500 to-blue-500 hover:from-green-600 hover:to-blue-600 text-white font-bold py-5 text-base shadow-lg"
